				...
				<div class="row">
                    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="Rental_term" class="form-control SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                            <!--placeholder-->
                                            <option title="Volvo is a car"  value="شمالي">شمالي</option>            
                                            <option value="saab">سنوي</option>                                 
                                            <option value="mercedes">شهري</option>
                                            <option value="audi">يومي</option>
                                            <option value="audi">تمليك</option>
                                        </select>
                                    </div>
                                    <div class="mb-4">
                                        <p class="mg-b-10">نوع العقار</p>
                                        <select name="property_id" class="form-control SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                            <!--placeholder-->
                                            <option title="Volvo is a car"  value="volvo">اختار نوع العقار</option> 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="future[]" multiple="multiple" class="testselect2">
                                            <option selected value="volvo">سطح خاص</option>
                                            <option value="saab">مدخل سيارة</option>
                                            <option value="mercedes">مكيفات</option>
                                            <option value="audi">مدخل خاص </option>
                                            <option value="saab">إطلالة على معلم رئيسي</option>
                                            <option value="mercedes">إنترنت</option>نادي رياضي مشترك 
                                            <option value="audi"> منطقة لعب للأطفال </option>
                                            <option value="audi">نادي رياضي مشترك </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div id="map" name =map style="height: 500px;width: 1000px; margin: 0 auto;"></div>
                           <p></p>
                           <p></p>
                           <h3></h3>
